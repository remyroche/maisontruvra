...
from backend.schemas import QuoteSchema, InvoiceSchema, InvoiceStatusUpdateSchema
...
@api_resource_handler(
    ...
    ownership_exempt_roles=['Admin', 'Manager', 'Support'],  # Staff can convert any quote
...
@api_resource_handler(
    ...
    ownership_exempt_roles=['Admin', 'Manager', 'Support'],  # Staff can update any invoice
