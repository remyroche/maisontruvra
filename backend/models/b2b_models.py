...
class B2BPartnershipRequest(BaseModel):
    ...
    requested_tier_id = db.Column(db.Integer, db.ForeignKey('b2b_tiers.id'), nullable=True)
    status = db.Column(db.Enum(B2BRequestStatus), default=B2BRequestStatus.PENDING, nullable=False)
